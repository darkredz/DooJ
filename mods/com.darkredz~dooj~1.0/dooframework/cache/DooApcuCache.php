...
/**
 * DooApcuCache provides caching methods utilizing the APC extension.
 *
 * @author Leng Sheng Hong <darkredz@gmail.com>
 * @version $Id: DooApcuCache.php 1000 2018-05-01 01:39
 * @package doo.cache
 */
class DooApcuCache
{
    ...
    {
        return apcu_store($id, $data, $expire);
    }
